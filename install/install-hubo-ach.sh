...
apt-get update
apt-get install libach1 libach-dev ach-utils autoconf automake libtool autoconf-archive
...
#apt-get update
#apt-get install -y --force-yes --no-remove libach1 libach-dev ach-utils hubo-ach-dev
