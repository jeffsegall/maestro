...
#include <hubomsg/HuboRef.h>
#include <hubomsg/AchCommand.h>
#include <hubomsg/PythonMessage.h>
...
namespace ros_integration {
  using namespace RTT;
    ...
    /** Declare all factory functions */
        ...
        void rtt_ros_addType_hubomsg_HuboRef();
        void rtt_ros_addType_hubomsg_AchCommand();
        void rtt_ros_addType_hubomsg_PythonMessage();
    ...
    public:
      ...
      virtual bool loadTypes() {
        ...
        rtt_ros_addType_hubomsg_HuboRef(); // factory function for adding TypeInfo.
        rtt_ros_addType_hubomsg_AchCommand(); // factory function for adding TypeInfo.
        rtt_ros_addType_hubomsg_PythonMessage(); // factory function for adding TypeInfo.
