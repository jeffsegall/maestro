  ...
  using namespace RTT;
      ...
      : public types::TransportPlugin
    {
      bool registerTransport(std::string name, types::TypeInfo* ti)
      {
         ...
         if(name == "/hubomsg/HuboRef")
              return ti->addProtocol(ORO_ROS_PROTOCOL_ID,new RosMsgTransporter<hubomsg::HuboRef>());
         if(name == "/hubomsg/AchCommand")
              return ti->addProtocol(ORO_ROS_PROTOCOL_ID,new RosMsgTransporter<hubomsg::AchCommand>());
         if(name == "/hubomsg/PythonMessage")
              return ti->addProtocol(ORO_ROS_PROTOCOL_ID,new RosMsgTransporter<hubomsg::PythonMessage>());
