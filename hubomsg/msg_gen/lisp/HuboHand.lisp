...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HuboHand>)))
  ...
  "e09ed47ff0eea79727916eba887d57d4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HuboHand)))
  "Returns md5sum for a message object of type 'HuboHand"
  "e09ed47ff0eea79727916eba887d57d4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HuboHand>)))
  ...
  (cl:format cl:nil "HuboJointState thumb~%HuboJointState index~%HuboJointState middle~%HuboJointState ring~%HuboJointState pinky~%~%================================================================================~%MSG: hubomsg/HuboJointState~%string name~%float64 commanded~%float64 position~%float64 velocity~%float64 current~%float64 temperature~%int32 active~%int32 zeroed~%int32 homed~%int32 status~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HuboHand)))
  "Returns full string definition for message of type 'HuboHand"
  (cl:format cl:nil "HuboJointState thumb~%HuboJointState index~%HuboJointState middle~%HuboJointState ring~%HuboJointState pinky~%~%================================================================================~%MSG: hubomsg/HuboJointState~%string name~%float64 commanded~%float64 position~%float64 velocity~%float64 current~%float64 temperature~%int32 active~%int32 zeroed~%int32 homed~%int32 status~%~%"))
