"""autogenerated by genpy from hubomsg/PythonMessage.msg. Do not edit."""
import sys
...
class PythonMessage(genpy.Message):
  _md5sum = "e1b182ddb50fa4986084202886606609"
  _type = "hubomsg/PythonMessage"
...
"""
  ...
  _slot_types = ['hubomsg/HuboJointCommand[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PythonMessage, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hubomsg.msg.HuboJointCommand()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
